...
**Generated:** 2026-09-06T15:22:56.636Z
...
| With gallery extras (>1 image / non-hero usage) | 0 |
| Lifestyle / on-foot usage | 0 |
| Missing primary | 0 |
...
| next/image `priority=` usages (components) | 9 |
| next/image `sizes=` usages (components) | 87 |
...
- `smith-attack-mag` — narrow-width:285 (`/images/running/accessories/smith-attack-mag-hero.png`)
- `sis-go-isotonic-gel` — narrow-width:349 (`/images/running/accessories/sis-go-isotonic-gel-hero.jpg`)
- `sis-beta-fuel-gel` — narrow-width:265 (`/images/running/accessories/sis-beta-fuel-gel-hero.png`)
- `sis-beta-fuel-drink` — narrow-width:342 (`/images/running/accessories/sis-beta-fuel-drink-hero.jpg`)
- `nuun-sport` — narrow-width:260 (`/images/running/accessories/nuun-sport-hero.png`)
...
| Reviews | 503 | 503 | 0 | 100 |
| Best guides | 58 | 38 | 20 | 65.5 |
...
| Metric | Count |
|---|---:|
| Reviews missing authorId | 503 |
| Unknown authorIds on reviews | 1 |
- Reviews by `undefined`: 503
