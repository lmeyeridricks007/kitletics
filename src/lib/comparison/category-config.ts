...
export const padelRacketComparisonConfig: ComparisonCategoryConfig = {
  ...
  specificationGroups: [
    {
      ...
      keys: ["weightMin", "weightMax", "thicknessMm"],
    },
    {
      id: "shape-balance",
      label: "Shape & Balance",
      keys: ["shape", "balance", "sweetSpot"],
    },
    {
      id: "construction",
      label: "Face & Core",
    ...
    },
    {
      id: "positioning",
      label: "Play Profile",
      keys: ["powerPositioning", "controlPositioning"],
    },
  ],
  primaryUseCaseIds: [
    "uc-padel-beginner",
  ...
  scoreFactors: [
    ...
    { key: "forgiveness", label: "Forgiveness", factorKeys: ["forgiveness", "sweet-spot"] },
