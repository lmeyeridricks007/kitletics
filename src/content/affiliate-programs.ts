...
export const affiliatePrograms: AffiliateProgram[] = [
  ...
  },
  {
    ...
    status: "pending",
    deepLinkMode: "provider",
    trackingIdEnvKey: "AMAZON_ASSOCIATES_TAG_FR",
    disclosureRequired: true,
    ...meta,
  },
  {
  ...
  {
    id: "aff-holland-padel",
    retailerId: "ret-holland-padel",
    networkId: "other",
    regionIds: ["NL", "BE"],
    status: "pending",
    deepLinkMode: "passthrough",
...
export const retailerStorefronts: RetailerStorefront[] = [
  ...
  },
  {
    ...
    currency: "EUR",
    affiliateProgramId: "aff-amazon-fr",
    status: "active",
  },
  {
    id: "sf-decathlon-nl",
  ...
  },
  {
    ...
    retailerId: "ret-justpadel",
    regionId: "NL",
    domain: "www.justpadel.com",
    currency: "EUR",
    affiliateProgramId: "aff-justpadel-awin",
    status: "active",
  },
  {
    id: "sf-padel2gether-nl",
    retailerId: "ret-padel2gether",
    regionId: "NL",
    domain: "www.padel2gether.nl",
    currency: "EUR",
    affiliateProgramId: "aff-padel2gether",
    status: "active",
  },
  {
    id: "sf-holland-padel-nl",
    retailerId: "ret-holland-padel",
    regionId: "NL",
    domain: "www.hollandpadel.com",
    currency: "EUR",
    affiliateProgramId: "aff-holland-padel",
    status: "active",
  },
  {
    id: "sf-padeldirect-nl",
    retailerId: "ret-padeldirect",
    regionId: "NL",
    domain: "www.padeldirect.nl",
    currency: "EUR",
    affiliateProgramId: "aff-padeldirect",
    status: "active",
  },
  {
    id: "sf-padelnu-nl",
    retailerId: "ret-padelnu",
    regionId: "NL",
    domain: "www.padelnu.nl",
    currency: "EUR",
    affiliateProgramId: "aff-padelnu",
    status: "active",
  },
  {
    id: "sf-takealot-za",
    retailerId: "ret-takealot",
    regionId: "ZA",
    domain: "www.takealot.com",
    currency: "ZAR",
    affiliateProgramId: "aff-takealot",
    status: "pending",
  },
];
