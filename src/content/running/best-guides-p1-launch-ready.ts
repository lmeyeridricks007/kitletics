...
const P1_PATCHES: Record<string, GuidePatch> = {
  ...
  "carbon-plated-running-shoes": {
    ...
    "methodologySummary": "Carbon plates plus race-day context. Nylon tempo plates belong in Best Tempo Shoes. Considered universe: published catalog products relevant to this intent. Shortlist requires a distinct decision role. Final recommendations are role winners. Affiliate commission does not influence considered, shortlisted, recommended, rank or award decisions.",
    "selectionMethodology": "Carbon plates plus race-day context. Nylon tempo plates belong in Best Tempo Shoes. Considered universe: published catalog products relevant to this intent. Shortlist requires a distinct decision role. Final recommendations are role winners. Affiliate commission does not influence considered, shortlisted, recommended, rank or award decisions.",
    "evidenceIds": [
      "ev-catalog-editorial"
    ],
    "whatWeLookFor": [
